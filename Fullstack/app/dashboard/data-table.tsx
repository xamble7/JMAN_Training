...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className="w-full md:w-[1020px] mx-auto">
      <div className="flex items-center py-4 mt-2 md:ml-[400px] justify-center md:justify-start">
        <Input
          ...
          className="w-[90vw] md:max-w-screen-md text-white"
        />
      </div>
      <div className="rounded-md text-white overflow-x-auto">
